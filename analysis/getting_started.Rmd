...
samples <- c("path/to/sample_1/count_file_1.h5 ", "path/to/sample_2/count_file_2.h5")
spotfiles <- c("path/to/sample_1/spot-selection.tsv", "path/to/sample_2/spot-selection.tsv")
imgs <- c("path/to/sample_1/HE_image_sample_1.jpg", "path/to/sample_2/HE_image_sample_2.jpg")
