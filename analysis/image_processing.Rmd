...
<br>
```{r show_warp, fig.height=10, fig.width=12, out.width = '100%'}
...
If you want to plot overlaid spatial heatmaps for multiple samples at the same time you can do this with the `FeatureOverlay()` function by specifing several _sampleids_ 
<br>
