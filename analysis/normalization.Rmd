...
```{r load_lib, warning=FALSE, message=FALSE, results="hide", autodep=TRUE}
library(STutility)
...
<br>
```{r poisson_comparison, fig.width = 4, fig.height = 8, cache=TRUE, warning=FALSE, message=FALSE, results='hide'}
