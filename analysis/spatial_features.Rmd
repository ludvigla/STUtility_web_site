...
<br>
```{r dimplot, fig.height=28, fig.width=18, out.width = "100%"}
...
<br>
```{r plot_clusters, fig.height = 7, fig.width = 12, out.width='100%'}
...
```{r embedding_vs_ST, fig.width = 16, fig.height = 22}
...
<br>
```{r UMAP_blend, fig.height = 7, fig.width = 12}
