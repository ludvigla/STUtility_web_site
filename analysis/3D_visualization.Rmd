...
HSVPlot3D(se, features = paste0("factor_", c(4,5,7,9,11,13,14,15,18,22,24,25,29,30,31,33,36)), pt.size = 1, dark.theme = T, add.margins = 1, mode = "spots")
...
p2 <- FeaturePlot3D(se, features = "Calb2", scene = "scene2", cols = c("dark blue", "navyblue", "cyan", "white"), dark.theme = TRUE, add.margins = 1)
